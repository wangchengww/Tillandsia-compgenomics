...
setwd('/home/clara/Documents/GitHub/Tillandsia-compgenomics/II. Expression figure/')
...
pdf("Expression_curve_PANEL_modules1_5_3.pdf", width = 10, height = 16)
######################### CLUSTER 5 #############################
...
p1b <- ggplot(tfas_cluster5, aes(x=time, y=count, group = gene_id)) +
  geom_line(data = medians_Tfas, aes(group = 1), size = 1, color = "black") +
  geom_vline(xintercept = 4.75, linetype = "dashed") +
  geom_vline(xintercept = 1.75, linetype = "dashed") +
  theme_bw() +
...
p2b <- ggplot(tlei_cluster5, aes(x=time, y=count, group = gene_id)) +
  geom_line(data = medians_Tlei, aes(group = 1), size = 1, color = "black") +
  geom_vline(xintercept = 4.75, linetype = "dashed") +
  geom_vline(xintercept = 1.75, linetype = "dashed") +
  theme_bw() +
  theme(axis.title.x=element_blank(),
